...
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.create = function (createUserDto) {
        if (!(0, isEmail_1.default)(createUserDto.mail)) {
            throw new common_1.BadRequestException('mail is not an email');
        }
        if ((0, isEmail_1.default)(createUserDto.pseudo)) {
            throw new common_1.BadRequestException('pseudo cannot be an email');
        }
        var newUser = new UserEntity_1.UserEntity();
        newUser.mail = createUserDto.mail;
        newUser.pseudo = createUserDto.pseudo;
        newUser.password = createUserDto.password;
        return this.repo.save(newUser);
    };
    UsersService.prototype.findByIdentifier = function (identifier) {
